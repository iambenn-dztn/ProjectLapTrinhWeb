...
<title>SIEUTHISMARTPHONE - Administrator</title>
...
<body>
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#"><span>SIEUTHISMARTPHONE</span>Shop</a>
						<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="index.php?page_layout=order"><svg class="glyph stroked two messages"><use xlink:href="#stroked-two-messages"/></svg> Quản lý đơn hàng</a></li>
		</ul>
	...
	if(isset($_GET["page_layout"])){
		...
		switch($_GET["page_layout"]){
			...
			case "edit_order": include_once("edit_order.php"); break;
		}
	}
	else{
		// goi trang dashboard
