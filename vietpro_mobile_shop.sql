...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 21, 2021 lúc 05:28 AM
...
(31, 1, 'NTD', 'ntd@gmail.com', '2020-03-03 21:03:10', 'lkdssjs'),
(32, 6, 'NTD', 'ntd@gmail.com', '2020-07-09 12:11:57', 'asdasdasdas');
...
(30, 9, 'Vivo Y81i Red hahaha hic', 'Vivo-Y81i-Red.png', 10000000, '12 Thï¿½ng', 'H?p, sï¿½ch, s?c, cï¿½p, tai nghe', 'Mï¿½y M?i 100%', 'Dï¿½n Mï¿½n Hï¿½nh 4DXáº¡c dá»± phÃ²ngXáº¡c dá»± phÃ²ngXáº¡c dá»± phÃ²ngXáº¡c dá»± phÃ²ng', 1, 0, 'S?n ph?m nï¿½y chï¿½ng tï¿½i ?ang c?p nh?t n?i dung chi ti?t, cï¿½c b?n cï¿½ th? qua tr?c ti?p c?a hï¿½ng ?? xem s?n ph?m, vï¿½ hï¿½ng chï¿½ng tï¿½i luï¿½n cï¿½ s?n.');
...
CREATE TABLE `tbl_order` (
  ...
  `order_mail` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `order_address` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `order_product` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `order_price` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tbl_order` (`order_id`, `order_name`, `order_number`, `order_mail`, `order_address`, `order_product`, `order_price`) VALUES
(18, 'Nguyễn Thế Điềm', '0338388565', 'nguyenthediem020999@gmail.com', 'mrdangerit@gmail.com', '1 : Nokia 1 red;3 : Vivo V7 Gold;', '30000000'),
(20, 'Nguyễn Thế T', '0338388565', 'nguyenthediem020999@gmail.com', 'mrdangerit@gmail.com', '1 : iPhone 7 Plus 32GB Rose Gold  ;3 : iPhone X 25', '40000000'),
(21, 'Điềm Nguyễn Thế Điềm', '0338388565', 'nguyenthediem020999@gmail.com', '249 Nguyễn Văn Trỗi, Mỗ Lao', '1 : iPhone X 256GB Silver Seedstock  ;2 : Samsung ', '40000000');
